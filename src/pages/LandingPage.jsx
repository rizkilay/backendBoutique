...
const LandingPage = () => {
    ...
    // Gestion de l'animation personnalisée de la carte centrale (effet autoTilt)
    ...
    useEffect(() => {
        ...
        // Si VanillaTilt est chargé globalement via le HTML principal :
    ...
    return (
        <div className="page-container">
            {/* Définitions des clips SVG */}
            <svg width="0" height="0" style={{ position: "absolute" }}>
                <defs>
                    <clipPath id="shopify-curve-clip" clipPathUnits="objectBoundingBox">
                        <path d="M 0,0 L 1,0 L 1,0.88 C 0.85,0.98 0.70,0.88 0.50,0.90 C 0.30,0.92 0.15,0.99 0,0.93 Z" />
                    </clipPath>
                    <clipPath id="shopify-curve-mobile-clip" clipPathUnits="objectBoundingBox">
                        <path d="M 0,0 L 1,0 L 1,0.94 C 0.85,0.98 0.65,0.92 0.50,0.94 C 0.35,0.96 0.15,0.99 0,0.97 Z" />
                    </clipPath>
                </defs>
            </svg>
                ...
                <div className="location-map-wrap">
                    <div className="map-card">
                        <iframe 
                            ...
                            title="Google Map location of Ambassade Dékon"
                        ></iframe>
